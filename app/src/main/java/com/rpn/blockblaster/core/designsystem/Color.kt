...
// ── Board background colours (Light mode) ────────────────────────────────────
//val BoardBackgroundLight = Color(0xFFF5F5F0)  // Warm off-white, easier on eyes than pure white
//val GridLineLight        = Color(0xFFD0D0C8)  // Soft warm gray, visible but not harsh

// Alternative: slightly cooler tones
val BoardBackgroundLight = Color(0xFF12122A)  // Cool off-white
val GridLineLight = Color(0xFF38385A)  // Soft cool gray
